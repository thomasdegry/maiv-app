...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.description = [[UILabel alloc] initAParagraphWithFontTravelerAndFrame:CGRectMake(320, 60, 150, 200) andSize:FontTravelerSizeMedium :[UIColor blue] andText:@"Start the burger quest by clicking on the ‘create’ button. Now you will be able to login with your Facebook account"];
